...
class FRM:
    def __init__(self, _destino, _bovedareg1, _immediate, _procesador):
        self.destino = _destino
        self.bovedareg1 = _bovedareg1
        self.inmediate = _immediate
    ...
    def execute(self):
        ...
        if self.bovedareg1 or self.bovedareg2:
            ...
            self.procesador.regALU.data = self.procesador.ALU.operar(tempA, tempB, 4)
        else:
    ...
    def memory(self):
        print(f"Sin operación de memoria para Mul")
