...
class Rotd:
    ...
    def instruccion2(self):
        ...
        self.procesador.regALU.data = self.procesador.ALU.operar(self.procesador.regRF.data, self.inmediate, 6)
    ...
    def ejecutar(self):
        if self.ejecucion:
            ...
            print("No hay más fases para ejecutar en Rotacion Derecha.")
