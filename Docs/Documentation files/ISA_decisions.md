...
En relacion con las instrucciones se definieron un total de 30. Entre ellas se establecieron 14 aritmeticas, aritmetico-logicas y shifts que abarcan las instrucciones más utilizadas en RISCV. Se definen 4 instrucciones para el hashing de datos las cuales están pensadas para facilitar el proceso de hashing al usuario además de dismuir el tiempo de ejecución unificando operaciones complejas en una sola instrucción. Se definen además 3 instrucciones de interacción con el vault las cuales permiten al usuario cargar y guardar datos de la bóveda de seguridad. Se definen 2 instrucciones de carga y almacenamiento las cuales permiten al usuario cargar y guardar datos de la memoria principal. Se definen 3 instrucciones de control de flujo las cuales permiten al usuario realizar saltos condicionales. Finalmente, se define una instrucción NOP la cual no realiza ninguna operación y es utilizada para evitar hazards en el pipeline.
